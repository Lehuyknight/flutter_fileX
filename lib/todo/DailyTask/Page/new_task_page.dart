...
class NewTaskPage extends StatefulWidget {
  NewTaskPage({Key? key, required this.listTask}) : super(key: key);
...
class _NewTaskPageState extends State<NewTaskPage> {
  ...
  void initState() {
    ...
    super.initState();
    widget.listTask.forEach((element) {
          ...
          if (_textEditingController.text.isNotEmpty && listDay.length > 0)
            Padding(
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  _insertDailyTask(Color(int.parse(selectedValue)),
      ...
      body: Stack(
        children: [
          colorItem.length > 0
              ...
              : Center(
                  child: Text('Đã hết tài nguyên màu, hãy xóa bớt kế hoạch'),
                )
        ],
      ),
    );
