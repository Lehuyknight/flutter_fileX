...
class S_DataBaseHelper {
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE $scheduleTable($colId INTEGER PRIMARY KEY AUTOINCREMENT, $colTitle TEXT, $colDate TEXT, $colDone TEXT, $colTime TEXT, $colNote TEXT)');
  }
  ...
  Future<int> changeStatus(String id, String isDone) async {
    var db = await this.database;
    int result = await db.update(scheduleTable, {'$colDone': isDone},
        where: '$colId = $id');
    return result;
  }
